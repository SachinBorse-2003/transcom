        ...
        <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          <Reveal>
            <SectionHeading
              ...
              title="Ten divisions. One standard of proof."
              lead="Energy, industrial and food commodities handled by specialists who know the certificate each destination actually asks for."
            />
          </Reveal>
          ...
          <div className="flex flex-col items-center justify-between gap-5 bg-navy-950 px-8 py-8 text-white sm:flex-row">
            <div>
              <p className="font-display text-[19px] font-semibold">
                Four more divisions — auto parts, mobile, seafood and staples.
              </p>
