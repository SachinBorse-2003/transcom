...
const slides = [
  {
    ...
    lead: 'A general trading house that sources, inspects and ships across energy, industry and food — from one office in Dubai to more than twenty-five markets.',
  ...
  },
  {
    ...
    lead: 'Refined petroleum products, tier-one solar equipment and certified electrical material, delivered on terms that survive an audit.',
  ...
  },
  {
    ...
    lead: 'Fresh, chilled and frozen foodstuff on an unbroken cold chain — graded, certified and traceable to the lot.',
    cta: { label: 'Foodstuff divisions', to: '/divisions/fruits-vegetables' },
  },
  {
    image: 'photo-1587293852726-70cdb56c2866',
    eyebrow: 'Logistics & Fulfilment',
    title: ['One counterparty,', 'end to end'],
    lead: 'Sourcing, inspection, documentation, freight and warehousing handled under a single accountable contract.',
